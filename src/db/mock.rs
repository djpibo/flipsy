        ...
        if trimmed.contains("TB_CENTER_INVENTORY") || trimmed.contains("INVENTORY") || trimmed.contains("ORDER") {
            ...
            let flat_nodes = vec![
                ...
                PlanNode {
                    ...
                    object_alias: Some(r#""I"@"SEL$1""#.to_string()),
                    outline_hints: vec![r#"FULL(@"SEL$1" "I"@"SEL$1")"#.to_string()],
                    qblock_name: Some("SEL$1".to_string()),
                    starts: 1,
                    e_rows: 30,
                    a_rows: 150_000,
                    a_time_ms: 8.12,
                ...
                PlanNode {
                    ...
                    object_alias: Some(r#""I"@"SEL$1""#.to_string()),
                    outline_hints: vec![r#"INDEX(@"SEL$1" "I"@"SEL$1" ("TB_CENTER_INVENTORY"."CENTER_CD"))"#.to_string()],
                    qblock_name: Some("SEL$1".to_string()),
                    starts: 1,
                    e_rows: 30,
                    a_rows: 150_000,
